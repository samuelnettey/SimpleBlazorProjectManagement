...
using Acme.ProjectManagement.Core.ProjectAggregate.Events;
using Acme.ProjectManagement.Core.ProjectAggregate.Handlers;

using Moq;

using Xunit;

namespace Acme.ProjectManagement.UnitTests.Core.Handlers
{
